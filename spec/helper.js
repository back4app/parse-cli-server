...
var cache = require('parse-server/lib/cache').default;
var express = require('express');
var path = require('path');
var TestUtils = require('parse-server/lib/TestUtils');
...
const PostgresStorageAdapter = require('parse-server/lib/Adapters/Storage/Postgres/PostgresStorageAdapter');
...
var ParseCliServer = require('../src/ParseCliServer').ParseCliServer;
...
var app = express();
var api = new ParseCliServer({config: defaultConfiguration}).app;
app.use('/1', api);
app.use('/1', (req, res) => {
  ...
  return new Promise((resolve, reject) => {
    server.close(() => {
      try {
        ...
        cache.clear();
        app = express();
        api = new ParseCliServer(newConfiguration).app;
